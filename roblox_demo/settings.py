"""
Django settings for roblox_demo project.
...
if DEBUG:
    ...
    RAILWAY_EXTERNAL_HOSTNAME = config('RAILWAY_EXTERNAL_HOSTNAME', default='')
...
# FIXED: Less aggressive security headers for development
if DEBUG:
...
WSGI_APPLICATION = 'roblox_demo.wsgi.application'
...
if DATABASE_URL:
    ...
    # Development - PostgreSQL in Development Mode
    DATABASES = {
        'default': {
